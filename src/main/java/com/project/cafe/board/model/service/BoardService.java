...
import com.project.cafe.member.model.member.repository.MemberRepository;
...
public class BoardService {
    ...
    public void updateBoard(String memberToken, BoardUpdateRequestDto boardUpdateRequestDto) {
        try {
            ...
            if (!boardUpdateRequestDto.getWriter().equals(member.getMemberId())) throw new AuthorizationException();
